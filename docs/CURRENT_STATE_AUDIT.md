...
| البحث الشامل (Global Search) — Ctrl+K، بحث حي عبر المشاريع/المهام/العملاء/الصفقات/الحركات المالية/الأحداث/الملفات مع تنقّل فعلي | **Working** | IndexedDB (Dexie) | بحث نصي حقيقي على البيانات المحمّلة فعليًا، وليس نتائج وهمية |
| الملفات (Files) — رفع/تنزيل/حذف حقيقي، تخزين Blob فعلي محليًا، ربط اختياري بمشروع/جهة اتصال | **Working** | IndexedDB (Dexie، v4) | تحقّق بايت-لبايت: تنزيل الملف بعد إعادة تحميل الصفحة يطابق المحتوى الأصلي تمامًا |
...
| AI Chat, Memory, Agents, Workflows, Prompt Library, Usage | **غير موجود** | — | لا تظهر كصفحات أو أزرار؛ فقط نص غير تفاعلي تحت "قريبًا" |
